...
RUN buildDeps="make gcc g++ libc-dev ruby-dev build-essential libssl-dev libxml2-dev libxslt1-dev zlib1g-dev" \
    ...
    && gem install fluentd-ui && fluentd-ui setup && gem sources --clear-all \
    && apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $buildDeps \
    && rm -rf /var/lib/apt/lists/* /tmp/* /var/tmp/* /usr/lib/ruby/gems/*/cache/*.gem

ENV FLUENTD_OPT="-d /root/.fluentd-ui/fluent.pid -c /root/.fluentd-ui/fluent.conf -o /root/.fluentd-ui/fluent.log -p /root/.fluentd-ui/plugins"
